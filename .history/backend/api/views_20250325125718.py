...
# Create a pet when the user selects it.
...
# Retrieve or update the current user's pet.
...
# Endpoint to feed the pet (+5% stat, capped at 100%).
...
# Endpoint to water the pet (+5% stat, capped at 100%).
